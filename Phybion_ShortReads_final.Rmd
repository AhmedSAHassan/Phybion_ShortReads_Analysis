...
bulk_genes <- mapIds(org.Hs.eg.db, keys = genes, column = "SYMBOL", keytype = "ENSEMBL", multiVals = "first")
...
sampled.metadata<-sampled.metadata[!sampled.metadata$free_annotation %in% c("erythrocyte", "granulocyte", "hematopoietic stem cell", "myeloid progenitor", "non-classical monocyte", "plasmablast", "plasmacytoid dendritic cell"), ]
...
deconv_bayesprism<- deconvolute(bulk_gene_expression = bulk_mat,
