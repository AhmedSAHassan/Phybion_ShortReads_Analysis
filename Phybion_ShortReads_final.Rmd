...
=======
>>>>>>> 17e2aeb5f2d032ccf9d00afa7469f06617b13875
```
...
gs_heatmap(
  ...
  gtl = gtl_t2_0.5Gy,
  geneset_id = "GO:0008630", anno_col_info = c("Dose", "Sex", "Time_point"), cluster_columns = FALSE, scale_row = T, column_labels = rep(c(1,2,3),10), column_names_rot = 360)
...
scored_mat_t1_1Gy_vs_0Gy <- GeneTonic::gs_scores(se = vsd_t1_corrected, gtl = gtl_t1_1Gy)
...
ht<-Heatmap(scored_mat_t1_1Gy_vs_0Gy[1:15,],
=======
anno_t2 <- as.data.frame(colData(vsd_phybion_t2)[, c("Sex", "Time_point", "Donors", "Dose")])
anno_t1 <- as.data.frame(colData(vsd_phybion_t1)[, c("Sex", "Time_point", "Donors", "Dose")])
...
#pheatmap(t(deconv_bayesprism[, - c(3,4,6,8,9,10, 15, 16, 18,21,22)]), annotation_col = anno, labels_col = rep(c(1,2,3), 10))
